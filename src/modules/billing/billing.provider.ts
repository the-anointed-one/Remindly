...
export interface BillingProvider {
    ...
    initializeSubscription(params: CreateSubscriptionParams): Promise<BillingSubscriptionResult>;
    cancelSubscription(subscriptionCode: string, emailToken: string): Promise<{ success: boolean; error?: string }>;
    verifyTransaction(reference: string): Promise<{ success: boolean; status?: string; error?: string }>;
}
