        ...
        const defaults = [
            {
                ...
                actions: [{
                    ...
                    type: 'send_sms',
                    delayMinutes: 0,
                    config: { message: "Hi {{customer_name}}, your appointment has been booked for {{scheduled_at}}. Reply YES to confirm or NO to cancel." },
                    conditions: [],
                }],
            },
            {
                ...
                actions: [{
                    ...
                    config: { message: "Hi {{customer_name}}, just a reminder about your appointment tomorrow. Reply YES to confirm or call us to reschedule." },
            ...
            },
            {
                ...
                actions: [{
                    ...
                    type: 'send_sms',
                    delayMinutes: 60,
                    config: { message: "Hi {{customer_name}}, thanks for visiting us today! We hope everything went well. Feel free to reach out if you need anything." },
                    conditions: [],
                }],
            },
        ];
